...
exports.getCheckMigrationCommand = exports.getCreateDbCommand = exports.getDropDbCommand = exports.getDbCheckCommand = exports.getDbTablesCommand = void 0;
 ...
 */
const getDbTablesCommand = (type = config_1.cfg.TYPE) => {
    switch (type) {
        case 'postgres':
...
exports.getDbTablesCommand = getDbTablesCommand;
/**
 ...
 */
const getDbCheckCommand = (type = config_1.cfg.TYPE) => {
    switch (type) {
        case 'postgres':
        ...
        case 'sqlite':
        case 'better-sqlite3':
            throw new Error('SQLite database existence should be checked via filesystem');
        default:
            throw new Error('Unsupported database type');
    }
};
exports.getDbCheckCommand = getDbCheckCommand;
/**
 ...
 */
const getDropDbCommand = (name, type = config_1.cfg.TYPE) => {
    switch (type) {
        case 'mariadb':
        case 'mysql':
        ...
        case 'better-sqlite3':
        case 'sqlite':
            throw new Error('SQLite databases should be dropped by deleting the file');
        default:
            throw new Error('Unsupported database type');
    }
};
exports.getDropDbCommand = getDropDbCommand;
/**
 ...
 * @throws When the type is unsupported.
 */
const getCreateDbCommand = (name, type = config_1.cfg.TYPE) => {
    switch (type) {
        case 'postgres':
        ...
        case 'sqlite':
        case 'better-sqlite3':
            throw new Error('SQLite databases are created by opening/creating the file');
        default:
            throw new Error('Unsupported database type');
    }
};
exports.getCreateDbCommand = getCreateDbCommand;
/**
 ...
 * @throws When the type is unsupported.
 */
const getCheckMigrationCommand = (type = config_1.cfg.TYPE) => {
    switch (type) {
        case 'postgres':
...
exports.getCheckMigrationCommand = getCheckMigrationCommand;
